...
interface UserOwnerInstance
  extends Model<UserOwnerAttributes, UserOwnerCreationAttributes>,
  UserOwnerAttributes { }

const UserOwnerModel = sequelizeInstance.define<UserOwnerInstance>(
  'UserOwner',
  {
    id: {
      primaryKey: true,
